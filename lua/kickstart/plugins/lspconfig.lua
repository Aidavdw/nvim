    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gd', require('telescope.builtin').lsp_definitions, '[G]oto variable [D]efinition')
          ...
          map('<leader>bs', require('telescope.builtin').lsp_document_symbols, ' [B]uffer LSP [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>ss', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[S]earch LSP [S]ymbols')
          ...
          map('<leader><leader>', vim.lsp.buf.code_action, 'Suggestion or Action', { 'n', 'x' })
